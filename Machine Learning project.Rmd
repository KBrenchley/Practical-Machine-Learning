...
This gave me 10 training sets with length of around `r length(train1)` and 10 testing sets (also taken from the training set) with length of around `r length(test1)`. I also needed to remove the classe variable from these test sets so that prediction could happen.
